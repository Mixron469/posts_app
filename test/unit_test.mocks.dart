...
// in posts_app/test/unit_test.dart.
...
import 'package:posts_app/data/services/api_service.dart' as _i10;
...
class MockApiService extends _i1.Mock implements _i10.ApiService {
  ...
  @override
  _i8.Future<List<dynamic>> getPosts() =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<Map<String, dynamic>> getPost(int? id) =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<List<dynamic>> getComments(int? postId) =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<Map<String, dynamic>> createPost(Map<String, dynamic>? data) =>
      (super.noSuchMethod(
            Invocation.method(#createPost, [data]),
            returnValue: _i8.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i8.Future<Map<String, dynamic>> updatePost(
    int? id,
  ...
  @override
  _i8.Future<void> deletePost(int? id) =>
      (super.noSuchMethod(
